  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-3xl items-center px-4 py-10">
      <div className="w-full rounded-2xl border border-gray-200 bg-white p-8 shadow-theme-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <h1 className="mt-3 text-3xl font-bold text-gray-950 dark:text-white">{t('errors.notFoundTitle')}</h1>
        <p className="mt-3 text-sm leading-7 text-gray-600 dark:text-gray-300">{t('errors.notFoundBody')}</p>
        <div className="mt-6 flex flex-wrap gap-3">
          ...
          <Link className="rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm font-semibold text-gray-700 dark:border-gray-700 dark:bg-gray-950 dark:text-gray-300" to="/auth">
            {t('page.auth.title')}
          </Link>
        </div>
      </div>
