...
export const resources = {
  en: {
    translation: {
      ...
      'actions.shortcuts':
        'Desktop shortcuts: j/k (move), Arrows (move), Shift+Arrows (range), Enter (open), Shift+Space (batch), p (pending filter), / (search focus), Ctrl/Cmd+A (visible batch), Ctrl/Cmd+Z (undo)',
  ...
  fr: {
    translation: {
      ...
      'actions.shortcuts':
        'Raccourcis desktop: j/k (navigation), Flèches (navigation), Shift+Flèches (sélection plage), Entrée (ouvrir), Shift+Espace (batch), p (filtre à traiter), / (focus recherche), Ctrl/Cmd+A (batch visible), Ctrl/Cmd+Z (annuler)',
