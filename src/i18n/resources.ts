...
export const resources = {
  en: {
    translation: {
      ...
      'actions.shortcuts':
        'Desktop shortcuts: j/k (move), Arrows (move), Shift+Arrows (range), Enter (open), Shift+Space (batch), g/v/x (KEEP/REJECT/CLEAR selected), p (pending filter), / (search focus), Ctrl/Cmd+A (visible batch), Ctrl/Cmd+Z (undo)',
  ...
  fr: {
    translation: {
      ...
      'actions.shortcuts':
        'Raccourcis desktop: j/k (navigation), Flèches (navigation), Shift+Flèches (sélection plage), Entrée (ouvrir), Shift+Espace (batch), g/v/x (KEEP/REJECT/CLEAR sélectionné), p (filtre à traiter), / (focus recherche), Ctrl/Cmd+A (batch visible), Ctrl/Cmd+Z (annuler)',
