export const frTranslation = {
  ...
  'library.subtitle': 'Espace de recherche et de requalification des assets archivés.',
  ...
  'actions.purgeRisk': "Action irréversible. Ancienneté visible avant purge: {age}.",
  ...
  'todo.title': 'États de file review',
  'todo.body': 'La décision humaine et le move appliqué restent séparés tant que l’exécution n’a pas été confirmée explicitement.',
  'todo.blockedTitle': 'Bloqués avant décision',
  'todo.blockedEmpty': 'Aucun asset bloqué avant décision humaine.',
  'todo.pendingTitle': 'Décision humaine en attente',
  'todo.pendingEmpty': 'Aucun asset en attente de décision humaine.',
  'todo.keepTitle': 'KEEP décidé, move non appliqué',
  'todo.keepEmpty': 'Aucune décision KEEP en attente d’application.',
  'todo.rejectTitle': 'REJECT décidé, move non appliqué',
  'todo.rejectEmpty': 'Aucune décision REJECT en attente d’application.',
  ...
  'detail.capturedAt': 'Capture: {value}',
  'detail.assetAge': 'Ancienneté asset: {value}',
  'detail.dateUnknown': 'date indisponible',
  'detail.ageUnknown': 'ancienneté indisponible',
  'detail.ageToday': 'capturé aujourd’hui',
  'detail.ageDays': '{count} jours',
  ...
  'reviewResolution.title': "Action bloquée par l'état courant du serveur",
  'reviewResolution.body': '{reason} Rafraîchir les données courantes avant de réessayer.',
  'reviewResolution.reasonStateConflict': "L'état de l'asset a changé côté serveur.",
  'reviewResolution.reasonPreconditionRequired': "Une précondition d'écriture requise est absente.",
  'reviewResolution.reasonPreconditionFailed': "La révision de l'asset est obsolète.",
  'reviewResolution.reasonLock': 'Un verrou ou un token de verrou obsolète bloque cette action.',
  'reviewResolution.actionRefreshSelectedAsset': "Rafraîchir l'asset sélectionné",
  'reviewResolution.actionRefreshAssetList': 'Rafraîchir la liste Review',
  'reviewResolution.refreshing': 'Rafraîchissement...',
