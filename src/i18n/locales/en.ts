export const enTranslation = {
  ...
  'library.subtitle': 'Research and requalification workspace for archived assets.',
  ...
  'actions.purgeRisk': 'Irreversible action. Visible asset age before purge: {age}.',
  ...
  'todo.body': 'Human decision and applied move stay separate until execution is explicitly confirmed.',
  'todo.blockedTitle': 'Blocked before decision',
  'todo.blockedEmpty': 'No asset is blocked before human decision.',
  'todo.pendingTitle': 'Pending human decision',
  'todo.pendingEmpty': 'No asset is waiting for a human decision.',
  'todo.keepTitle': 'KEEP decided, move not applied',
  'todo.keepEmpty': 'No KEEP decision is waiting for apply.',
  'todo.rejectTitle': 'REJECT decided, move not applied',
  'todo.rejectEmpty': 'No REJECT decision is waiting for apply.',
  ...
  'detail.capturedAt': 'Captured: {value}',
  'detail.assetAge': 'Asset age: {value}',
  'detail.dateUnknown': 'date unavailable',
  'detail.ageUnknown': 'age unavailable',
  'detail.ageToday': 'captured today',
  'detail.ageDays': '{count} days',
  ...
  'reviewResolution.title': 'Action blocked by current server state',
  'reviewResolution.body': '{reason} Refresh the current data before retrying.',
  'reviewResolution.reasonStateConflict': 'The asset state changed on the server.',
  'reviewResolution.reasonPreconditionRequired': 'A required write precondition is missing.',
  'reviewResolution.reasonPreconditionFailed': 'The asset revision is stale.',
  'reviewResolution.reasonLock': 'A lock or stale lock token blocks the action.',
  'reviewResolution.actionRefreshSelectedAsset': 'Refresh selected asset',
  'reviewResolution.actionRefreshAssetList': 'Refresh review list',
  'reviewResolution.refreshing': 'Refreshing...',
