export const enTranslation = {
  ...
  'page.activity.body':
    'The separate shell is now in place. This page stays limited to a local operator journal until a richer backend contract exists.',
  ...
  'page.activity.next1': 'Replace the legacy review journal with a dedicated space.',
  'page.activity.next2': 'Structure entries by action, result, and correlation id.',
  'page.activity.next3': 'Extend local persistence only if it remains bounded.',
