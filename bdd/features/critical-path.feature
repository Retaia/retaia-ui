...
Feature: Parcours critiques de review
  ...
  Scenario: Naviguer entre review activity library detail et retour contexte
    ...
    Then l'URL courante contient "/review/asset/A-001"
    And l'URL courante contient "from=%2Freview%3Fstate%3DDECISION_PENDING"
    Given je suis sur la page "/review/asset/A-001?from=%2Factivity"
    Then l'URL courante contient "/review/asset/A-001"
    And l'URL courante contient "from=%2Factivity"
    When je clique sur le bouton "Bibliothèque"
    Then l'URL courante contient "/library"
    Given je suis sur la page "/library/asset/A-002?from=%2Flibrary"
    Then l'URL courante contient "/library/asset/A-002"
    And l'URL courante contient "from=%2Flibrary"
